...
BUKUM_F_0_2_MM = 60.0    # 0.8mm - 2.0mm arası (dahil değil)
BUKUM_F_2_5_MM = 55.0     # 2.0mm - 5.0mm arası (dahil değil)
BUKUM_F_5_6_MM = 50.0     # 5.0mm - 6.0mm arası (dahil değil)
BUKUM_F_6_10_MM = 40.0    # 6.0mm - 10.0mm arası (dahil)
BUKUM_F_STANDART = 65.0  # Tanımsız aralıklar için varsayılan
